...
# copied from https://registry.hub.docker.com/r/tradingai/bazel/dockerfile
# so we can update dependencies ourselves as we choose
FROM nvidia/cuda:10.0-cudnn7-devel-ubuntu18.04

MAINTAINER vogt4nick@gmail.com
