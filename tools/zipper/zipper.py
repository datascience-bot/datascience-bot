...
def _get_argument_parser():
    ...
    parser.add_argument("-o", "--output", type=str, help="The output zip file path.")
    ...
    parser.add_argument(
        "-s", "--stripprefix", type=str, help="The root of the executable",
    )

    parser.add_argument(
        "-P", "--extrapaths", type=str, help="Comma delimited list of extra paths",
    )

    parser.add_argument(
        "-D", "--delimiteddirs", type=str, help="Comma delimited list of provider dirs",
    )
